...
date: "2020-3-02"
slug: reasons-or-rationalisations
...
```{r reasonsfig1, fig.cap = "*Responses to critical slide and exclusion*", include=TRUE}
...
```{r reasonsfig2, fig.cap = "*Responses to critical slide and exclusion*", include=TRUE}
...
```{r S3reasonsfig2, fig.cap = "*Responses to critical slide and exclusion*", include=TRUE}
...
```{r S3reasonsfig3, fig.cap = "*Responses to critical slide and exclusion*", include=TRUE}

# color for Study 2 "#B4B4B4"
# Figure\ \@ref(fig:reasonsfig2)

ggplot(test, aes(x = Study, y = sample_perc2, fill = convergence)) +
   scale_y_continuous(limits = c(-.085,1),
                      labels = percent_format()
                      )+ 
  geom_col(position = "dodge",
  ...
  theme_apa()+
  scale_fill_manual(values = c("#f05e23", "#1034a6", "#0080ff"),
                    labels=c("Endorsing\nOnly\n",
                              "Endorsing and\nArticulating\n",
